...
<button @click="sortEpisodes" style="padding-left: 20px; padding-right: 20px; border-radius: 20px; background-color: red;
" >
Sort By Episode Count
</button>

<button @click="sortseasonCount" style="padding-left: 20px; padding-right: 20px; border-radius: 20px; background-color: red;
">
